class FkProductCarouselCtrl {
  constructor($rootScope, $element, fkGlobalNavService) {
...
FkProductCarouselCtrl.$inject = ['$rootScope', '$element', 'fkGlobalNavService'];

export default FkProductCarouselCtrl;
